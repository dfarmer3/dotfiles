...
This repo basically serves as a way to preserve the countless hours I've spent meticulously customizing my nerd computer setup, as well as a sort of art project to ~~flex on the normies~~ show off my sorta-artistic skills with (I do have a life, thanks for asking 😂). I have files sparsely organized, but for the most part I use my `copyconfig` script to organize my config directories.
